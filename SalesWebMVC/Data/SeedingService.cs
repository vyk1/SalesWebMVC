...
namespace SalesWebMVC.Data {
    public class SeedingService {
        ...
        public void Seed() {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1999, 4, 21), 1800.1, d3);
            Seller s2 = new Seller(2, "Claude Clark", "claude@gmail.com", new DateTime(1997, 2, 22), 1000.0, d2);
            Seller s3 = new Seller(3, "Daniel Dunn", "daniel@gmail.com", new DateTime(1994, 12, 23), 1307.82, d1);
            Seller s4 = new Seller(4, "Eleonor Eckhardt", "eleonor@gmail.com", new DateTime(1990, 6, 17), 1500.13, d2);
            Seller s5 = new Seller(5, "Fanny Fontez", "bob@gmail.com", new DateTime(1992, 8, 15), 1700.45, d3);
            Seller s6 = new Seller(6, "Gail Giacomo", "bob@gmail.com", new DateTime(1995, 1, 3), 1800.1, d1);
